...
from mmdet3d.core import (Box3DMode, Coord3DMode, bbox3d2result,
                          merge_aug_bboxes_3d, show_result, show_multi_modality_result)
...
class MVXTwoStageDetector(Base3DDetector):
    ...
    def forward_train(self,
        ...
        #     savepoint["P0"] = img_metas[0]["P0"]

        #     savepoint["points_transed"] = points # transed
        #     from mmdet3d.models.fusion_layers.coord_transform import apply_3d_transformation
        #     transed_scene_points1 = apply_3d_transformation(points[0][:, :3], 'LIDAR', img_metas[0], reverse=True)
        #     transed_scene_points2 = apply_3d_transformation(points[1][:, :3], 'LIDAR', img_metas[1], reverse=True)
        #     transed_scene_points3 = apply_3d_transformation(points[2][:, :3], 'LIDAR', img_metas[2], reverse=True)
        #     transed_scene_points4 = apply_3d_transformation(points[3][:, :3], 'LIDAR', img_metas[3], reverse=True)
        #     transed_scene_points5 = apply_3d_transformation(points[4][:, :3], 'LIDAR', img_metas[4], reverse=True)
        #     transed_scene_points = [transed_scene_points1, transed_scene_points2, transed_scene_points3, transed_scene_points4, transed_scene_points5]
        #     savepoint["points_to_ori"] = transed_scene_points # sampled to ori
            
        #     bbox_location1 = gt_bboxes_3d[0].center.numpy()
        #     bbox_location2 = gt_bboxes_3d[1].center.numpy()
        #     bbox_location3 = gt_bboxes_3d[2].center.numpy()
        #     bbox_location4 = gt_bboxes_3d[3].center.numpy()
        #     bbox_location5 = gt_bboxes_3d[4].center.numpy()
        #     savepoint["bbox_location"] = [bbox_location1, bbox_location2, bbox_location3, bbox_location4, bbox_location5]

        #     savepoint["gt_labels_3d"] = gt_labels_3d
        #     print("yep")
    ...
    def show_results(self, data, result, out_dir):
        ...
        for batch_id in range(len(result)):
            ...
            # hack failed
            # img = data['img'][0]._data[0].numpy()
            # img = img.transpose(1, 2, 0)
            # show_pred_bboxes = LiDARInstance3DBoxes(pred_bboxes, origin=(0.5, 0.5, 0))
            # show_multi_modality_result(img, None, show_pred_bboxes, data['img_metas'][0]._data[0][batch_id]['lidar2img'], out_dir, 
            #     filename=file_name, depth_bbox=False, img_metas=None, show=False, gt_bbox_color=(61, 102, 255), pred_bbox_color=(241, 101, 72))
