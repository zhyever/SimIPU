...
## change to generate reduced gt labels.
def create_waymo_info_file(data_path,
    ...
    filename = save_path / f'{pkl_prefix}_infos_train_reduce.pkl'
    ...
    _calculate_num_points_in_gt(
        ...
        num_features=6,
        remove_outside=False)
    filename = save_path / f'{pkl_prefix}_infos_val_reduce.pkl'
    print(f'Waymo info val file is saved to {filename}')
    mmcv.dump(waymo_infos_val, filename)
    filename = save_path / f'{pkl_prefix}_infos_trainval_reduce.pkl'
    ...
    waymo_infos_test = get_waymo_image_info(
        ...
        relative_path=relative_path,
        max_sweeps=max_sweeps)
    filename = save_path / f'{pkl_prefix}_infos_test_reduce.pkl'
